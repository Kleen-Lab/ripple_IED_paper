...
x_ticks = [-0.2:0.1:0.2];
x_lims = [-0.2 0.2];
q_133 = load('/Users/dazhang/seahorse/data/an/transformed/RR_h_referential_wSPKS/EC133/AN/EC133_AN_ch293_wSPKS.mat').q;
...
subplot(4,4,[9 13]);   
pcolorjk(ts(time_start:time_end), q_133.frx(q_133.frx>=2), spectrogram(:,time_start:time_end));
set(gca,'yscale','log');
caxis([-6 6]);
