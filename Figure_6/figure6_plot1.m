...
% Load raw trace
% ============================================================
raw_data = load('/scratch/dazhang/MATLAB/EC186_513/ls_trace_EC186_Channel_300_binsize_1_Block_1.mat');

raw_trace = raw_data.ls_traces(33, :);
...
% ============================================================
filtered_data = load( ...
    '/scratch/dazhang/MATLAB/EC186_513/ls_filtered_trace_EC186_Channel_300_binsize_1_Block_1.mat');

filtered_trace = filtered_data.ls_filtered_traces(33, :);
...
filtered_tick_max =  300;
filtered_tick_min = -300;
