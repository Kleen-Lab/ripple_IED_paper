% Raw
raw_data = load( '/scratch/dazhang/MATLAB/EC222_513/ls_trace_EC222_Channel_270_binsize_1_Block_2.mat');
raw_trace = raw_data.ls_traces(58, :);

% Filtered trace
filtered_data = load('/scratch/dazhang/MATLAB/EC222_513/ls_filtered_trace_EC222_Channel_270_binsize_1_Block_2.mat');
filtered_trace = filtered_data.ls_filtered_traces(58, :);
